						...
						<ul class="nav nav-drawer">
							...
							<li class="nav-item nav-item-has-subnav active open"><a
								...
								<ul class="nav nav-subnav">
									...
									<li class="active"> <a href="${pageContext.request.contextPath }/teacher/toSelecttitlelist.action">查看选题学生</a> </li>
								</ul></li>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/toSelecttitlelist.action"
	...
	function jumpPage(pageNumber){
	  ...
	  function agreeSelTitle(sId,titlId) {
		  if(confirm('确定同意该学生吗? 其他学生将无法选择该门课题')){
			  $.post("<%=basePath%>teacher/editSelTitle.action",{"sId":sId, "titlId":titlId, "seltitlState":"同意"},
						function(data){
						            if(data =="OK"){
						                alert("操作成功！");
	  ...
	  function refuseSelTitle(sId,titlId) {
		  if(confirm('确定拒绝该学生吗? 他将被限制再选择该门课题')){
			  $.post("<%=basePath%>teacher/editSelTitle.action",{"sId":sId, "titlId":titlId, "seltitlState":"拒绝"},
						function(data){
						            if(data =="OK"){
						                alert("操作成功！");
						                window.location.reload();
