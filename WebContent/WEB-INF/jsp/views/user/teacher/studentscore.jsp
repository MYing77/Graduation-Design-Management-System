        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/studentScore.action">学生成绩总评</a> </li>
              </ul>
            </li>
          </ul>
        </nav>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							...
							<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/studentScore.action"
	...
	function jumpPage(pageNumber){
	  ...
	  function getfId (fId) {
	    ...
	    function saveStudentScore() {
	    	...
	    	$.post("<%=basePath%>teacher/editStudentScore.action",
