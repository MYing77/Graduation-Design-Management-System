        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav open active">
              ...
              <ul class="nav nav-subnav">
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/leading/projBooklist.action">任务书</a> </li>
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 任务书 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/leading/projBooklist.action"
										...
										<tbody>
											<c:forEach var="projBook" items="${pageInfo.list }"
												...
												<tr>
													...
													<td>
													<button style="border:0;background: none;" type="button" data-toggle="tooltip" data-placement="top" title="第一次预览可能需要等待较长时间"><a href="${pageContext.request.contextPath }/file/toPdfProjBook.action?num1=${projBook.fId }&num2=${projBook.tId }">${projBook.fName }</a></button>
													</td>
													...
													<input data-toggle="modal"
														data-target="#commentsInfoModal" type="button" class="btn btn-primary btn-xs" id="comment"
																	name="search2" value='指导教师意见' onclick="getcomment(${projBook.fId})">
													<a href="${pageContext.request.contextPath }/file/filedown.action?fId=${projBook.fId}&tId=${projBook.tId}&tName=${projBook.tName}"><input type="button" class="btn btn-primary btn-xs" id="download"
