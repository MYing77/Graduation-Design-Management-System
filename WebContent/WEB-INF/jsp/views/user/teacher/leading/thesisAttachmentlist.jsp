          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav open active">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/leading/thesisAttachmentlist.action">附件</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 学生附件下载 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/leading/thesisAttachmentlist.action"
										...
										<tbody>
											<c:forEach var="thesisAttachment" items="${pageInfo.list }"
												...
												<tr>
													...
													<td>
													<a href="${pageContext.request.contextPath }/file/filedown.action?fId=${thesisAttachment.fId}&tId=${thesisAttachment.tId}&tName=${thesisAttachment.tName}"><input type="button" class="btn btn-primary btn-xs" id="download"
