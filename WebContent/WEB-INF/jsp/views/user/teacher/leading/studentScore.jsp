...
<body>
      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            <li class="nav-item"> <a href="${pageContext.request.contextPath }/teacher/leading/Index.action" onclick="location.reload()"><i class="mdi mdi-home"></i> 首页</a> </li>
            ...
            <li class="nav-item nav-item-has-subnav open active">
              ...
              <ul class="nav nav-subnav">
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/leading/studentScore.action">学生成绩总评</a> </li>
              </ul>
            </li>
          </ul>
        </nav>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							...
							<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/leading/studentScore.action"
							...
							<div class="card-body">
							    ...
							    <p></p> 
							    <a href = "${pageContext.request.contextPath }/teacher/leading/export.action"><button type="submit" class="btn btn-label btn-primary"><label><i class="mdi mdi-checkbox-marked-circle-outline"></i></label>导出</button></a>
								<p></p>
							...
							<form id="selectById_title_form">
										<div class="form-group">
											...
											<div class="example-box">
												<textarea readonly style="height: 200px" name="content" id="content"
	...
	function jumpPage(pageNumber){
	  ...
	  function getfId (fId) {
	    ...
	    function getcomment1(replyComments,sId,replyScore,titlId) {
	    	$("#titlId").val(titlId);
			$("#replyComments").val(replyComments);
			$("#sId").val(sId);
	    ...
	    function saveStudentScore() {
	    	$.post("<%=basePath%>teacher/leading/editStudentScore.action",
	  ...
	  //评阅教师对论文编辑评语、评分
	    function getReviewBySId(sId) {
	    	$("#review_Comments").val("");
	    	$("#reviewScore").val("");
	    	$("#review_Comments1").val("");
	    	$("#reviewScore1").val("");
	    	$("#review_Comments2").val("");
	    	$("#reviewScore2").val("");
	    	$.ajax({
		        type:"get",
