          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav open active">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/leading/thesislist.action">论文</a> </li>
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 论文 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/leading/thesislist.action"
												...
												<tr>
													...
													<input data-toggle="modal"
														data-target="#commentsInfoModal" type="button" class="btn btn-primary btn-xs" id="comment"
																	name="search2" value='指导教师意见' onclick="getcomment(${thesis.fId})">
													<a href="${pageContext.request.contextPath }/file/filedown.action?fId=${thesis.fId}&tId=${thesis.tId}&tName=${thesis.tName}"><input type="button" class="btn btn-primary btn-xs" id="download"
