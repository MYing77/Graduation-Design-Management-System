          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav open active">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/leading/totitlelist1.action">待审核课题</a> </li>
              </ul>
            </li>
...
<div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/leading/totitlelist1.action"
										...
										<tbody>
											<c:forEach var="title" items="${pageInfo.list }"
												...
												<tr>	
													...
													<td>
													<input type="button" class="btn btn-success btn-xs" id="del"
																	name="del" value='通过' onclick="checkTitle(${title.titlId},'已审批')">
													<input type="button" class="btn btn-danger btn-xs" id="del"
																	name="del" value='不通过' onclick="checkTitle(${title.titlId},'审批不通过')">
													</td>
												</tr>
											</c:forEach>
										</tbody>
	...
	function jumpPage(pageNumber){
	  ...
	  function checkTitle(titlId,s) {
		  if(confirm('确定该操作吗？')) {
				$.post("<%=basePath%>teacher/leading/checkTitle.action",{"titlId":titlId,"titlState":s},
				function(data){
				            if(data =="OK"){
				                alert("操作成功！");
