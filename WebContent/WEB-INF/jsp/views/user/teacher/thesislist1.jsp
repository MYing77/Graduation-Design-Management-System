          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/thesislist1.action">待审核论文</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 待审核论文 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/thesislist1.action"
												...
												<tr>
													...
													<input data-toggle="modal"
														data-target="#commentsInfoModal" type="button" class="btn btn-primary btn-xs" id="comment"
																	name="search2" value='审核' onclick="Values('${thesis.sId}',${thesis.fId})">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<input hidden="hidden" type="text" id="role" name="role" value="论文">
