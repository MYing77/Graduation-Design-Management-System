						...
						<ul class="nav nav-drawer">
							...
							<li class="nav-item nav-item-has-subnav active open"><a
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									任务书管理</a>
								<ul class="nav nav-subnav">
									<li class="active"><a href="${pageContext.request.contextPath }/student/projBooklist.action">任务书</a></li>
								</ul></li>
								<li class="nav-item nav-item-has-subnav"><a
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									开题报告管理</a>
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 提交任务书 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/student/projBooklist.action"
							...
							<c:if test="${i eq 1 && i2 eq 0}">
							    ...
							    <input id="fType" type="text" name="fType" hidden="hidden" value="任务书">
										...
										<tbody>
											<c:forEach var="projBook" items="${pageInfo.list }"
												...
												<tr>
													...
													<a href="${pageContext.request.contextPath }/file/filedown.action?fId=${projBook.fId}"><input type="button" class="btn btn-primary btn-xs" id="download"
