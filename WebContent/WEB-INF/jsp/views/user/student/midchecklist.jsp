					...
					<nav class="sidebar-main">
						<ul class="nav nav-drawer">
							...
							<li class="nav-item nav-item-has-subnav active open"><a
								...
								<ul class="nav nav-subnav">
									<li class="active"><a href="${pageContext.request.contextPath }/student/midChecklist.action">中期检查</a></li>
								</ul></li>
							<li class="nav-item nav-item-has-subnav"><a
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 提交中期检查 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/student/midChecklist.action"
							...
							<c:if test="${i eq 1 && i2 eq 0}">
							    ...
							    <input id="fType" type="text" name="fType" hidden="hidden" value="中期检查">
												...
												<tr>
													...
													<input data-toggle="modal"
														data-target="#commentsInfoModal" type="button" class="btn btn-primary btn-xs" id="comment"
																	name="search2" value='查看指导教师建议' onclick="getcomment(${midCheck.fId})">
													<a href="${pageContext.request.contextPath }/file/filedown.action?fId=${midCheck.fId}"><input type="button" class="btn btn-primary btn-xs" id="download"
