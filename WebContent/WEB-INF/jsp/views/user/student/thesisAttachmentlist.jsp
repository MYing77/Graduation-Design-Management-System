						...
						<ul class="nav nav-drawer">
							...
							<li class="nav-item nav-item-has-subnav active open"><a
								href="javascript:void(0)"><i class="mdi mdi-attachment"></i>
									附件</a>
								<ul class="nav nav-subnav">
									<li class="active"><a href="${pageContext.request.contextPath }/student/thesisAttachmentlist.action">附件上传 (学生)</a></li>
								</ul></li>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/student/thesisAttachmentlist.action"
										...
										<tbody>
											<c:forEach var="thesisAttachment" items="${pageInfo.list }"
												...
												<tr>
													...
													<a href="${pageContext.request.contextPath }/file/filedown.action?fId=${thesisAttachment.fId}"><input type="button" class="btn btn-primary btn-xs" id="download"
